...
class Review:
    ...
    def __init__(self, year, summary, employee_id, id=None):
        self.id = id
        self.year = year  # This will call the year setter
        self.summary = summary  # This will call the summary setter
        self.employee_id = employee_id  # This will call the employee_id setter
    ...
    def find_by_id(cls, id):
        """Return a Review instance corresponding to the row in the "reviews" table with that same id, or None."""
        sql = """
            SELECT *
            FROM reviews
            WHERE id = ?
